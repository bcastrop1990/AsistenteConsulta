...
import com.senasa.bpm.ng.masajes.dao.MasajesCitasDao;
...
@Service
@Slf4j
public class MasajesCitasDaoImpl implements MasajesCitasDao {
...
//    }
    ...
    public int[] obtenerHorasDisponibilidad(String email) {
        ...
        return secondaryJdbcTemplate.queryForObject(sql, new Object[]{email}, (rs, rowNum) -> new int[]{
