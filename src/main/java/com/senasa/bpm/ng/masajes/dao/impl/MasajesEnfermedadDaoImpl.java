...
import com.senasa.bpm.ng.masajes.dao.MasajesEnfermedadDao;
...
@Service
@Slf4j
public class MasajesEnfermedadDaoImpl implements MasajesEnfermedadDao {
    ...
    public List<EnfermedadesBean> listarEnfermedadesPrimarias() {
        ...
        try {
            return secondaryJdbcTemplate.query(sql, new EnfermedadesPrimariasRowMapper());
    ...
    public List<Producto> listarProducto() {
        ...
        try {
            return secondaryJdbcTemplate.query(sql, new ProductoRowMapper());
        } catch (EmptyResultDataAccessException e) {
            // Retornar una lista vacía en lugar de Optional.empty() cuando no hay resultados
            return Collections.emptyList();}
    }
    ...
    public List<EnfermedadesBean> listarPorEnfrPr(Long id)  {
        ...
        try {
            return secondaryJdbcTemplate.query(sql, new EnfermedadesRowMapper(), id);
        } catch (EmptyResultDataAccessException e) {
            return Collections.emptyList();}
    }
    @Override
    public List<Producto> listarProductoPorMarca(Long id)  {
        ...
        try {
            return secondaryJdbcTemplate.query(sql, new ProductoRowMapper(), id);
        } catch (EmptyResultDataAccessException e) {
            return Collections.emptyList();
        }
    }
    ...
    public List<Marca> listarMarcas() {
        ...
        try {
            return secondaryJdbcTemplate.query(sql, new MarcaRowMapper());
        } catch (EmptyResultDataAccessException e) {
            return Collections.emptyList();}
    }
    @Override
    public String agregarProd(Producto request) {
        ...
        if (secondaryJdbcTemplate.queryForObject(sqlCount, Integer.class, codigo) >= 1){
        ...
        return String.valueOf(secondaryJdbcTemplate.update(sql, request.getNombre(), request.getMarca(), request.getDesc(),
    ...
    public Datos obtenerDatos() {
        ...
        try {
            String marcaMasSolicitada = secondaryJdbcTemplate.queryForObject(sqlMarcaMasSolicitada, String.class);
        ...
        try {
            datos.setCantidadAprobados(secondaryJdbcTemplate.queryForObject(sqlAprobados, Integer.class));
            datos.setCantidadDesaprobados(secondaryJdbcTemplate.queryForObject(sqlDesaprobados, Integer.class));
            datos.setMarcaMasSolicitada(secondaryJdbcTemplate.queryForObject(sqlMarcaMasSolicitada, String.class));
            datos.setCantidadFinanciamiento(secondaryJdbcTemplate.queryForObject(sqlFinanciamiento, Integer.class));
            datos.setCantidadAlContado(secondaryJdbcTemplate.queryForObject(sqlAlContado, Integer.class));
            datos.setCantidadTarjetaCredito(secondaryJdbcTemplate.queryForObject(sqlTarjetaCredito, Integer.class));
        } catch (EmptyResultDataAccessException e) {
            return new Datos();
        }
    ...
    public String cambiarEstado(Activo request) {
        ...
        String.valueOf(secondaryJdbcTemplate.update(sql, request.getActivo(), request.getId()));
    ...
    public DatosImportantes listarDatosImportantes() {
        ...
        int totalFilas = secondaryJdbcTemplate.queryForObject(sqlTotalFilas, Integer.class);
        ...
        Map<String, Long> filasPorModelo = secondaryJdbcTemplate.query(sqlFilasPorModelo, (rs, rowNum) ->
        ...
        Map<String, Long> filasPorMarca = secondaryJdbcTemplate.query(sqlFilasPorMarca, (rs, rowNum) ->
        ...
        List<Map<String, Object>> estadosPorSemana = secondaryJdbcTemplate.queryForList(sqlEstadosPorSemana);
    ...
    public String agregarCategoria(Categoria request) {
        ...
        return String.valueOf(secondaryJdbcTemplate.update(sql, request.getNombre()));
    }
    ...
    public void eliminarProducto(Long codigo) {
        ...
        if (secondaryJdbcTemplate.queryForObject(sqlCount, Integer.class, codigo) == 0){
            throw new ApiValidateException("El producto con el codigo: "+codigo+" no existe.");
        } else if (secondaryJdbcTemplate.queryForObject(sqlCount2, Integer.class, codigo) >= 1){
        ...
        String.valueOf(secondaryJdbcTemplate.update(sql, codigo));
    }
    @Override
    public List<Cliente> listarClientes() {
        ...
        try {
            return secondaryJdbcTemplate.query(sql, new ClienteRowMapper());
        } catch (EmptyResultDataAccessException e) {
            // Retornar una lista vacía en lugar de Optional.empty() cuando no hay resultados
            return Collections.emptyList();}
    }
    ...
    public Page<Cliente> listarClientesMotoFacil(String celular, String nombre_completo, String ubicacion, String cuota_inicial, String modelo, String marca, String email, String dni, String tipo_compra, String estado, LocalDate fechaDesde, LocalDate fechaHasta, String activo, int page) {
        ...
        NamedParameterJdbcTemplate namedParameterJdbcTemplate = new NamedParameterJdbcTemplate(secondaryJdbcTemplate.getDataSource());
    ...
    public List<Venta> listarPorFecha(Date desde, Date hasta) {
        ...
        try {
            return secondaryJdbcTemplate.query(sql, new VentaRowMapper(), desde, hasta);
        } catch (EmptyResultDataAccessException e) {
            return Collections.emptyList();
        }
    }
    ...
    public List<Venta> listarTodo() {
        ...
        try {
            return secondaryJdbcTemplate.query(sql, new VentaRowMapper());
        } catch (EmptyResultDataAccessException e) {
            return Collections.emptyList();
        }
    }
    ...
    public List<Venta> listarPorMes(int mes, int año) {
        ...
        try {
            return secondaryJdbcTemplate.query(sql, new VentaRowMapper(), mes, año);
        } catch (EmptyResultDataAccessException e) {
            return Collections.emptyList();
        }
    }
    ...
    public List<Venta> listarPorAño(int año) {
        ...
        try {
            return secondaryJdbcTemplate.query(sql, new VentaRowMapper(), año);
        } catch (EmptyResultDataAccessException e) {
            return Collections.emptyList();
        }
    }
    ...
    public List<Venta> listarPorDia(int dia, int mes, int año) {
        ...
        try {
            return secondaryJdbcTemplate.query(sql, new VentaRowMapper(), dia, mes, año);
        } catch (EmptyResultDataAccessException e) {
            return Collections.emptyList();
        }
    }
    ...
    public void guardar(String celular, String nombres, String apellidos, String estado) {
        ...
        String.valueOf(secondaryJdbcTemplate.update(sql, nombres, apellidos, estado, celular));
    }
    ...
    public void guardarInfoMotoFacil(String celular, String nombre_completo, String ubicacion, String tipo_compra, String cuota_inicial, String modelo, String marca, String email) {
        ...
        int countModelo = secondaryJdbcTemplate.queryForObject(sqlCheckModelo, new Object[]{modelo}, Integer.class);
        if (countModelo == 0) {
            String sqlInsert = "INSERT INTO MODELO_MOTO_FACIL (descripcion) VALUES (?)";
            secondaryJdbcTemplate.update(sqlInsert, modelo);
        }
        //PASO 2: insertar en MARCA_MOTO_FACIL
        String sqlCheckMarca = "SELECT COUNT(*) FROM MARCA_MOTO_FACIL WHERE descripcion = ?";
        int countMarca = secondaryJdbcTemplate.queryForObject(sqlCheckMarca, new Object[]{modelo}, Integer.class);
        if (countMarca == 0) {
        ...
        secondaryJdbcTemplate.update(sql, nombre_completo, ubicacion, tipo_compra, cuota_inicial, modelo, marca, email, celular);
    ...
    public void guardarPrimero(String celular) {
        ...
        if (secondaryJdbcTemplate.queryForObject(sqlCount, Integer.class, celular) >= 1){
        }else{
            String sql = "INSERT INTO clientes_moto_facil (celular) VALUES (?)";
            String.valueOf(secondaryJdbcTemplate.update(sql, celular));
        }
    }
    @Override
    public String getAnswer(String prompt) {
        ...
        List<String> clientesList = secondaryJdbcTemplate.query(sqlQuery, new RowMapper<String>() {
    ...
    public String obtenerValorTokenPorId(int id) {
        ...
        return secondaryJdbcTemplate.queryForObject(sql, new Object[]{id}, String.class);
    }
