...
import com.senasa.bpm.ng.masajes.dao.MasajesDoctorDao;
...
@Service
@Slf4j
public class MasajesDoctorDaoImpl implements MasajesDoctorDao {
...
*/
    ...
    public  List<DoctorCubaMedResponse> listarDoctor(Long idEspecialidad, String nombre){
        ...
        return secondaryJdbcTemplate.query(sql.toString(), params.toArray(), (rs) -> {
    ...
    public void configurarDisponibilidadDoctor(DoctorDisponibilidadRequest request) {
        ...
        Integer count = secondaryJdbcTemplate.queryForObject(checkSql, new Object[]{idDoctor}, Integer.class);
        ...
        if (count != null && count > 0) {
            ...
            String updateSql = "UPDATE doctor_disponibilidad SET fecha_inicio = ?, fecha_fin = ?, dias_semana = ?, color = ?, " +
                    ...
                    "WHERE idDoctor = ?";
            secondaryJdbcTemplate.update(updateSql,
            ...
            String insertSql = "INSERT INTO doctor_disponibilidad (idDoctor, fecha_inicio, fecha_fin, dias_semana, color, " +
                    ...
                    "hora_inicio_domingo, hora_fin_domingo) " +
                    "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            secondaryJdbcTemplate.update(insertSql,
                    idDoctor,
                    request.getFechaInicio(),
                    request.getFechaFin(),
                    String.join(",", request.getDiasSemana()),
    ...
    public Long obtenerIdDoctorPorCorreo(String email) {
        ...
        return secondaryJdbcTemplate.queryForObject(sql, new Object[]{email}, Long.class);
    }
    ...
    public DoctorCubaMedDisponibilidadResponse obtenerDisponibilidadPorCorreo(String email) {
        ...
        try {
            return secondaryJdbcTemplate.queryForObject(sql, new Object[]{idDoctor}, (rs, rowNum) ->
    ...
    public DoctorResponse guardarDoctor(DoctorRequest doctorRequest) {
        ...
        secondaryJdbcTemplate.update(connection -> {
    ...
    public List<DoctorResponse> listarTodosLosDoctores() {
        ...
        return secondaryJdbcTemplate.query(sql, (rs, rowNum) ->
    ...
    public DoctorResponse alternarEstadoDoctor(int id) {
        ...
        Integer estadoActual = secondaryJdbcTemplate.queryForObject(sqlSelect, new Object[]{id}, Integer.class);
        ...
        secondaryJdbcTemplate.update(sqlUpdate, nuevoEstado, id);

        // Obtener los datos actualizados del doctor
        String sqlGetDoctor = "SELECT * FROM doctores WHERE id = ?";
        return secondaryJdbcTemplate.queryForObject(sqlGetDoctor, new Object[]{id}, (rs, rowNum) ->
                DoctorResponse.builder()
                        .id(rs.getLong("id"))
                        .nombre(rs.getString("nombre"))
                        .apellido(rs.getString("apellido"))
